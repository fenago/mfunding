-- Touches now include REAL calls (activity_log interaction_type='call', mirrored
-- automatically by the GHL event hook) — processor_touches alone had 1 row ever
-- while 191 real calls/wk were invisible to the tracker.
