...
- [ ] Later enhancements noted: GHL document-completed webhook (workflow → ghl-webhook branch) to replace polling; white-label the link.vibereach.io signing domain; decide whether to deactivate the native duplicate templates once GHL path is proven (owner call)
