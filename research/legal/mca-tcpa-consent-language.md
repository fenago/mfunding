...
> Use this consent text on lead forms, landing pages, applications, and calculators that capture a phone number. Keep the consent checkbox **unchecked by default** and **not** a condition of any quote where required by law. Confirm placement and wording with counsel.

## Short Form (form checkbox / landing page)
...
## Expanded Form (application / disclosure page)
...
## SMS Program Disclosure (for the texting program)
...
## Required Operational Practices (internal)
- Record the **timestamp, IP, page/source, and exact consent text** shown at capture; retain proof.
- Honor **STOP / opt-out immediately** and propagate to the internal DNC list.
- Observe **quiet hours (8a–9p recipient local time)** and stricter state limits.
- Scrub against National DNC + internal DNC + litigator lists before dialing.
- For MCA, never use the word "loan" in any message (use funding/capital/advance).

---

*Attorney to confirm consent wording, default-state of checkbox, separation of marketing vs. transactional consent, and one-to-one consent requirements applicable at time of use.*
