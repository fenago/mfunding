# Bank Verification & Credit Authorization (incl. Plaid Consent)
...
Merchant signature: _________________________  Print name: [SIGNER NAME], [TITLE]  Date: __________

*Note for attorney: confirm conformity with FCRA permissible-purpose, GLBA, ECOA/Reg B, and Plaid's end-user requirements before use.*
