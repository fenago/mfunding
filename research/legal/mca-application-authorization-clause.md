# MCA Merchant Application — Bottom Authorization / Consent Clause

**Source:** required language per Lendini feedback (Jul 2, 2026). This REPLACES the
acknowledgment paragraph at the bottom of the `MCA_Merchant_Funding_Application`
template (Section 7, above the signature block).

**⚠ Two probable typos in the vendor-provided text — confirm with Lendini before
or after use (kept verbatim below):**
1. Item (5): "request and receive **and** investigative reports" — likely "and
   receive investigative reports".
2. Item (6): "waives and releases **and** claims" — likely "any claims".
