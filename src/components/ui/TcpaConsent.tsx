  ...
  return (
    <label className="flex items-start gap-3 cursor-pointer rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40 p-4">
      ...
      <span className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
        By checking this box, I give my <strong>express written consent</strong> for Momentum Funding
        (mfunding.net) and its representatives and funding partners to contact me at the phone number and
        email I provided — including by <strong>automatic telephone dialing system, prerecorded or
        artificial voice, and SMS/text messages</strong> — about funding options and related offers.{" "}
        <strong>Consent is not a condition of any purchase.</strong> Message frequency varies; message and
