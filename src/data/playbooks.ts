...
const MCA_CLOSE_STEPS: PlaybookStep[] = [
  {
    ...
    do: [
      ...
      "Point them at the portal too: everything the email delivers — the application, e-sign, and the upload link — is ALSO in their portal at my.mfunding.net (same email, one-tap sign-in link, no password). The portal is in addition to email, never instead of it.",
    ],
    say: "Based on what you told me, you look like a solid fit. I'm emailing you the funding application to complete and e-sign, a quick disclosure, and a secure link to upload your documents. Let's knock out the e-signature right now while I'm on with you — it takes about three minutes — and if you can snap photos of your ID and a voided check, we're 90% done. The bank statements you can upload tonight from the same link; it keeps working and each upload just adds on. I just hit send — if it's not in your inbox within a minute, check your spam folder; if it landed there, drag it to your inbox and reply 'got it' so I know you have it. And by the way — everything I just sent also lives in your secure portal at my.mfunding.net. Sign in with this same email, no password needed, and you can upload, e-sign, and watch exactly where your funding stands. Everything still comes by email too.",
  ...
  },
  {
    ...
    do: [
      ...
      "PORTAL SHORTCUT: if the merchant has portal access (check the Portal chip in the context bar), send their sign-in link and say: 'fastest way is your portal — my.mfunding.net; snap photos right from your phone, no attachments.' The email upload link keeps working too.",
    ],
  ...
  },
  {
    ...
    say: "I've got two options. Option A is more capital with slightly higher payments; Option B is lower payments. Which feels better for your weekly cash flow? I've also put your options side by side in your portal — open my.mfunding.net and we can walk through them together while we're on the phone.",
  },
  {
    n: 8,
    title: "Accept + e-sign",
...
export const PLAYBOOKS: Playbook[] = [
  ...
  // ─────────────────────────────────── REAL-TIME / APPOINTMENT (hot) ───────────────────────────────────
  {
    ...
    tagline: "Synergy emailed it in — nobody is on the phone. Email inside 5 minutes, call when THEY said to.",
    pipeline: "mca",
    revenue: "≈ $4,000 avg commission · lead cost $10–$20",
    entry: "Synergy emails the lead to sales@ → auto-parsed into a deal at New (HOT) with a 5-minute EMAIL countdown.",
    workFrom: {
      screen: "Open the deal from the top of My Day — the countdown is running",
      route: "/admin/playbooks",
      appNote:
        "This is NOT a live transfer. Nobody is being handed to you on the phone — Synergy pre-qualified this merchant and emailed the lead in. The system parsed it into a deal at New, pinned it to the TOP of your My Day, and dropped their full qual (revenue, FICO, funding request, existing balances) into the snapshot. Two things are true at once and you must do BOTH: speed-to-lead is what we pay for (touch them inside 5 minutes), AND the merchant told us the best time to reach them. Those conflict — so the 5-minute touch is an EMAIL, and the phone call goes at the time they asked for.",
    },
    steps: [
      {
        n: 1,
        title: "EMAIL them inside 5 minutes — then call at THEIR time",
        stageKey: "new",
        automation: "MCA 01 — Speed to Lead",
        ...
        do: [
          ...
          "Do not cold-dial a merchant at 9am who asked for 4pm just to beat a stopwatch — you burn a lead we paid for to satisfy a metric.",
          "If they said 'anytime', or their stated window is open right now, call immediately as well as emailing. Best of both.",
          "No answer at their stated time? Redial +15m → +1h → next business day before letting it fall to nurture.",
        ],
        route: { to: "/admin/deals", label: "Open the hot deal (top of My Day)" },
        say: "Hi [First Name] — [Closer] with Momentum Funding. You just spoke with our team about working capital for [Business Name]. I've got your details and I'm pulling your options now. You mentioned [best time] is best to reach you — I'll call then. If you'd rather talk sooner, just reply to this and I'll ring you right away.",
        note: "The 5-minute clock on the card is an EMAIL clock, not a call clock. Live transfers are the ones where someone is actually on the line — those have no countdown at all, because the call IS the event.",
      },
      {
        n: 2,
