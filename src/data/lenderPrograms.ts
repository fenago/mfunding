...
export const PROGRAM_FIELDS: ProgramField[] = [
  ...
  { key: "doc_bank_statement_months", label: "Bank statements required", short: "Bank statements (months)", type: "number", unit: "mo", doc: true, help: "months of statements" },
  { key: "doc_application", label: "Signed application", short: "Signed application", type: "bool", doc: true },
  { key: "doc_photo_id", label: "Photo ID / driver\u2019s license", short: "Photo ID", type: "bool", doc: true },
  { key: "doc_voided_check", label: "Voided check", short: "Voided check", type: "bool", doc: true },
  { key: "doc_mtd_statement", label: "Month-to-date statement", short: "Month-to-date stmt", type: "bool", doc: true },
  { key: "doc_proof_of_ownership", label: "Proof of ownership", short: "Proof of ownership", type: "bool", doc: true },
  { key: "doc_cc_processing", label: "Credit-card processing statements", short: "CC processing", type: "tri", doc: true, options: CC_AR_OPTIONS },
