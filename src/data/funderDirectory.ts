...
const ENRICHED: Funder[] = [
  ...
  { name: "Uplyft Capital", category: "low_revenue", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://uplyftcapital.com", applyUrl: "https://app.impact.com/campaign-promo-signup/Uplyft-Capital.brand", phone: "1-800-515-7531", criteria: "Credit as low as 475 · $5K–$5M · 24-hr approvals · affiliate program $200–$600/funded deal" },
...
const VERIFY: Record<string, Verify> = {
  ...
  "Bow Apple Capital": { status: "dead", note: "Domain suspended (Bluehost); only social profiles remain" },
  "Bridge Funding Capital": { status: "dead", note: "Cloudflare DNS error; named in MCA litigation — site not resolving" },
  ...
  "Capback": { status: "dead", note: "Framer 'Site Not Found' 404; unverifiable" },
  ...
  "Fundura Capital": { status: "dead", note: "Dead domain + Chapter bankruptcy (2026)" },
  ...
  "Infinity Capital Funding": { status: "dead", note: "Domain repurposed to unrelated site; MCA division sold 2020" },
  ...
  "Lendfi Corp": { status: "dead", note: "Domain parked/for-sale on HugeDomains ($4,295)" },
  ...
  "Nulook Capital": { status: "dead", note: "Chapter 11 bankruptcy 2017 — defunct" },
  ...
  "SPG Advance": { status: "dead", note: "Website suspended (Marketing 360); only LinkedIn remains" },
  "SPIER Capital": { status: "active", website: "https://www.spiercapital.com", phone: "(917) 933-2105" },
  "SRS Capital Funds": { status: "dead", note: "Chapter 7 bankruptcy (2021); domain DNS fails" },
  ...
  "Silver Street Funding": { status: "dead", note: "DNS fails — no live site (real litigated LLC 2022)" },
  ...
  "Super Fast Cap": { status: "dead", note: "Domain parked; appears on MCA blacklists as 'Super Fast Capital'" },
  ...
  "Upsize Capital": { status: "dead", note: "Domain suspended (upsizecapital.com)" },
  ...
  "Zinch": { status: "dead", note: "No MCA funder by this name — likely defunct/misnamed" },
};
