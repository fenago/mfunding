...
const ENRICHED: Funder[] = [
  ...
  { name: "BizFund", category: "low_revenue", paper: "B-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://bizfund.com", phone: "1 (302) 883-8306", criteria: "Direct funder · $10K+/mo · 6+ mo · 3–12 mo terms · offer in ~4 hrs · 'second chance' weak-credit · 'Apply to become an ISO' · merchant-only apply page (no ISO page)", verified: "active" },
  ...
  { name: "Slate Advance", category: "low_revenue", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.slateadvance.com", phone: "(646) 437-6011", criteria: "Direct funder · cash advances $5K–$5M · submit deals via ISO channel · merchant-only site (no live ISO page)", verified: "active" },
  ...
  { name: "Lendr", category: "low_revenue", paper: "B-C", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://lendr.online", criteria: "MCA + loans · up to $250K · 12+ mo · $10K+/mo · A+ BBB · $500M+ funded · 24-hr funding", verified: "active" },
  { name: "Yardline", category: "mainstream", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://yardline.com", criteria: "E-commerce growth-capital platform · up to $20M · $10K+/mo · 6+ mo · inventory/RBF/term/PO/SBA · multi-lender", verified: "active" },
  ...
  { name: "24Capital", category: "low_revenue", paper: "C-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://24capital.com", criteria: "$500M+ funded · decade in MCA · site is now syndicator/investor-facing (no public ISO-submission page found)", verified: "active" },
  ...
  { name: "One Park Financial", category: "low_revenue", paper: "B-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.oneparkfinancial.com", criteria: "Direct MCA funder · up to $500K · runs an ISO/broker sign-up program (no public apply URL exposed)", verified: "active" },
];
