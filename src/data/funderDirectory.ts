...
const ENRICHED: Funder[] = [
  ...
  { name: "Expansion Capital Group", category: "mainstream", paper: "A-C", lowRev: false, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.ecg.com", applyUrl: "https://www.ecg.com/partners/contact-us", criteria: "Direct funder · $1.5B+ / 40,000+ businesses funded · 6+ mo TIB · consolidations · ~30-min decisions", verified: "active" },
  { name: "Elevate Funding", category: "iso_whitelabel", paper: "B-C", lowRev: false, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://elevatefunding.com", applyUrl: "https://elevatefunding.com/partner-signup-form", criteria: "Boutique revenue-based finance / MCA funder (10+ yrs) · dedicated ISO partners program", verified: "active" },
  { name: "IOU Financial", category: "mainstream", paper: "A-B", lowRev: false, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://ioufinancial.com", applyUrl: "https://app.ioufinancial.com/brokers/new", criteria: "Direct small-business lender · separate ISO-partner + referral tracks · partner portal", verified: "active" },
  ...
  { name: "Headway Capital", category: "mainstream", paper: "A-B", lowRev: false, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://headwaycapital.com", criteria: "Business line-of-credit provider (Enova/Elevate family) · dedicated partners program · ⚠ ISO apps paused — refers partners to OnDeck", verified: "active" },
  ...
  { name: "Cardiff", category: "direct", paper: "A-C", lowRev: false, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://cardiff.co", applyUrl: "https://cardiff.co/affiliate", criteria: "MCA + working capital / equipment / asset-based · same-day approvals · dedicated partner program", verified: "active" },
  { name: "Fundfi Merchant Funding", category: "low_revenue", paper: "B-C", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.fundfimerchantfunding.com", applyUrl: "https://www.fundfimerchantfunding.com/referral-partners", criteria: "NY-based direct MCA funder · ISO-partnership program promoted on site (deep ISO URL 404s)", verified: "active" },
  ...
  { name: "Newity", category: "mainstream", paper: "A-B", lowRev: false, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://newitymarket.com", applyUrl: "https://newitymarket.com/faster-funding-for-finance-broker-clients", criteria: "SBA 7(a) working-capital lender service provider (for Northeast Bank) · broker/referral partner program — SBA, not MCA", verified: "active" },

  // ── Web sweep #2 (July 2026, FireCrawl-verified live) — subprime / high-risk / direct ──
  { name: "Everest Business Funding", category: "low_revenue", paper: "B-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.everestbusinessfunding.com", applyUrl: "https://everestbusinessfunding.com/partners", phone: "(305) 851-0900", criteria: "Cash-flow based (not credit) · 500+ credit · $5K+/mo · up to $2M · no startups · 1,000+ Trustpilot (4.5) · Miami · has ISO/partner program", verified: "active" },
  { name: "FundKite", category: "low_revenue", paper: "B-C", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.fundkite.com", applyUrl: "https://fundkite.com/broker", phone: "(877) 502-5003", criteria: "Direct RBF funder since 2015 · $10K–$2M · 550+ credit · 1+ yr · $10–20K/mo · 4-hr approval · next-day · A+ BBB", verified: "active" },
  { name: "NewCo Capital Group", category: "mainstream", paper: "B-C", lowRev: false, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.newcocapitalgroup.com", applyUrl: "https://www.newcocapitalgroup.com/partners", phone: "(800) 522-8817", criteria: "$50K–$2M · 550+ credit · 1+ yr · $75K+/mo · 3-hr approval · RBF + line of capital · 55K+ funded (note: low Trustpilot)", verified: "active" },
  { name: "Wynwood Capital Group", category: "low_revenue", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.wynwoodcapitalgroup.com", applyUrl: "https://www.wynwoodcapitalgroup.com/isoprogram", criteria: "$10K+/mo · 6+ mo · quick approval · dedicated ISO program", verified: "active" },
  { name: "Fenix Capital Funding", category: "low_revenue", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.fenixcapitalfunding.com", applyUrl: "https://www.fenixcapitalfunding.com/partner-with-us", criteria: "Small-business alt funder · up to $200K · 750+ industries served · 'Become a Partner' ISO program", verified: "active" },
  { name: "ROK Financial", category: "mainstream", paper: "A-C", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.rok.biz", applyUrl: "https://www.rok.biz/partner-multistep-apply", criteria: "Financing marketplace + direct · 500+ credit · $10K+/mo · 6+ mo · up to $5M · full suite (term/WC/LOC/SBA/equip/AR-PO/CRE)", verified: "active" },
  { name: "Highland Hill Capital", category: "low_revenue", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.highlandhillcap.com", criteria: "Alternative-finance MCA funder · ISO program (onboarding via DocuSign)", verified: "active" },
  { name: "Cedar Advance", category: "low_revenue", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://cedaradvance.com", applyUrl: "https://cedaradvance.com/iso-affiliates.php", phone: "786-605-8900", criteria: "Miami direct MCA funder · ISO / affiliate program", verified: "active" },
  { name: "Green Note Capital", category: "low_revenue", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.greennotecapital.com", applyUrl: "https://www.greennotecapital.com/iso", phone: "312-819-4081", criteria: "Direct MCA funder · small-biz cash advance + credit lines + advance consolidation · works with ISOs", verified: "active" },
  { name: "Altbanq (SOS Capital)", category: "direct", lowRev: false, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://altbanq.com", applyUrl: "https://altbanq.com/partners", phone: "(212) 235-5455", criteria: "NY alternative-finance funder (formerly SOS Capital) · term loans + MCA + payment processing", verified: "active" },
  { name: "GRP Funding", category: "mainstream", lowRev: false, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.grpfunding.com", applyUrl: "https://www.grpfunding.com/sales-partner", criteria: "Berlin, CT · nationwide · full suite (term/LOC/SBA/equipment/CRE/fix-&-flip/factoring/business cash advance)", verified: "active" },
  ...
  // ── Web sweep #3 (July 2026, FireCrawl + agent-verified live) — subprime/direct ──
  { name: "Amerifi Capital", category: "low_revenue", paper: "C-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://amerificapital.com", applyUrl: "https://amerificapital.com/partners/", criteria: "Direct funder · MCA + equipment + working capital · up to $8M · 52K+ merchants funded · protects ISO relationships", verified: "active" },
  { name: "Cobalt Funding Solutions", category: "low_revenue", paper: "C-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.cobaltfunding.com", applyUrl: "https://www.cobaltfunding.com/contact-us-sign-up", criteria: "RBF $10K–$3M for businesses declined by banks · pre-qual <24hr · ISO commissions + monthly bonuses + dedicated ISO Relations Mgr", verified: "active" },
  { name: "In Advance Capital", category: "low_revenue", paper: "C-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://inadvancecap.com", applyUrl: "https://inadvancecap.com/partnership/", phone: "(646) 412-3303", criteria: "Direct MCA/ACH funder · FICO from 550 · bad-credit OK · 1st–3rd positions · up to $2M · same-day · bank-only program", verified: "active" },
  { name: "Pinnacle Business Funding", category: "low_revenue", paper: "B-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.pbffunding.com", applyUrl: "https://www.pbffunding.com/partners", phone: "410-696-1967", criteria: "$5K–$250K in 24hr · high approval rate · same-day · ISO / broker / funder partner program", verified: "active" },
  { name: "Nationwide Capital Solutions", category: "low_revenue", paper: "C-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://nationwidecapitalsolution.com", applyUrl: "https://nationwidecapitalsolution.com/partner-with-us/", criteria: "$10K–$5M · 'no credit or income checks' · ~90% approval · 2-hr funding · $700M+ funded · Partner With Us ISO form", verified: "active" },
  { name: "Liquidity Access", category: "low_revenue", paper: "C-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://liquidityaccess.com", applyUrl: "https://liquidityaccess.com/iso/", phone: "631-641-7100", criteria: "Alt financing for subpar-credit / limited-history businesses · same-day · ISO agreement (JotForm)", verified: "active" },
  { name: "Instagreen Capital", category: "low_revenue", paper: "C-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://instagreencapital.com", applyUrl: "https://instagreencapital.com/iso/", criteria: "MCA + emergency/same-day funds + LOC · high approval rates · ISO partner program w/ fast payouts", verified: "active" },
  { name: "Berkman Financial", category: "low_revenue", paper: "B-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://berkmanfinancial.com", applyUrl: "https://berkmanfinancial.com/partners", phone: "800-201-0771", criteria: "$10K–$2M · no hard credit pull · same-day · MCA/RBF/LOC/invoice/consolidation · broker + ISO referral (PartnerHQ)", verified: "active" },
  { name: "NextGen Capital Solutions", category: "low_revenue", paper: "B-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://nextgencapitalsolution.com", applyUrl: "https://nextgencapitalsolution.com/broker-services/", phone: "(888) 927-9004", criteria: "Direct MCA funder · up to $250K · ISO commissions up to 19% · low syndication fee · online broker app", verified: "active" },
  { name: "Fundmerica", category: "low_revenue", paper: "B-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.fundmerica.com", applyUrl: "https://www.fundmerica.com/partner/", phone: "(888) 490-3126", criteria: "Santa Ana CA direct funder · affiliate / broker deal-submission partner program", verified: "active" },
  { name: "Capital Express LLC", category: "low_revenue", paper: "B-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.capitalexpressllc.com", applyUrl: "https://www.capitalexpressllc.com/best-mca-iso-program/", criteria: "NYC direct MCA funder since 2016 · $100M+ originated · up to $500K+ · 2-hr approvals · ISO program", verified: "active" },
  { name: "Advance Funds Network", category: "low_revenue", paper: "B-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://advancefundsnetwork.com", applyUrl: "https://advancefundsnetwork.com/become-a-partner/", phone: "(888) 800-9057", criteria: "Since 2008 · $1B+ funded · partner/ISO program up to 50% commission · white-label", verified: "active" },
  { name: "World Business Lenders", category: "direct", paper: "B-C", lowRev: false, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://wbl.com", applyUrl: "https://wbl.com/partners", phone: "(800) 432-9359", criteria: "Direct secured-lending funder · Partner Broker Referral Program · $200K–$2M", verified: "active" },
  { name: "EIN Cap", category: "mainstream", paper: "A-C", lowRev: false, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.eincap.com", phone: "(877) 651-8110", criteria: "NYC direct MCA funder · $45K+/mo · up to $1M · same-day · ISO subs via EinSubmissions@eincap.com (no public ISO page)", verified: "active" },
  { name: "Broadway Advance", category: "low_revenue", paper: "B-C", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.broadwayadvance.com", phone: "(212) 804-8083", criteria: "NYC MCA funder · ISO relations via isorelations@broadwayadvance.com · ⚠ may also broker to syndicate partners", verified: "active" },
  { name: "Flash Advance", category: "low_revenue", paper: "B-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.flashadvance.com", phone: "(888) 959-4323", criteria: "Direct MCA + small-biz funder · up to $500K · 1-hr approvals · ISO subs via info@flashadvance.com", verified: "active" },
  { name: "Cresthill Capital", category: "low_revenue", paper: "C-D", lowRev: true, whiteLabel: false, applyOnce: false, isoProgram: true, website: "https://www.cresthillcapital.com", phone: "(917) 521-6528", criteria: "Direct micro / small-biz working-capital funder · ISO subs via bizdev@cresthillcapital.com", verified: "active" },

  // -- Marketplaces / apply-once -> many funders (July 2026 FireCrawl sweep, verified live) --
  { name: "Money-360", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.money-360.com", applyUrl: "https://www.money-360.com/for-isos", criteria: "ISO ✓ submit · ISO submits once -> smart-matched to 50+ direct lenders; real-time tracking + weekly payouts; not a direct lender", verified: "active" },
  { name: "RelFi", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://relfi.co", applyUrl: "https://relfi.co/partner", criteria: "ISO ✓ submit · ISO funding marketplace -> 75+ funders (working capital/SBA/asset-backed); ~$220M/mo volume; single submission", verified: "active" },
  { name: "Lenders Access", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://lendersaccess.com", applyUrl: "https://lendersaccess.com/#register", criteria: "ISO ✓ submit · Broker submits one app -> 10-15 options from 98+ programs, often within an hour; free; 1,700+ brokers; $325M deployed (submit@lendersaccess.com)", verified: "active" },
  { name: "Funding Network", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: true, website: "https://www.fundingnetwork.dev", applyUrl: "https://fundingnetwork.dev/#brokers", criteria: "ISO ✓ submit · Broker submits merchant file once; command center tracks offers across matched lender network; white-label doc portal", verified: "active" },
  { name: "B2 Systems", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://b2systems.io", applyUrl: "https://b2systems.io/funder-submissions", criteria: "ISO ✓ submit · Broker sends one MCA file -> matched funders from 70+ network; replies to inbox; app-reader/statement-parser tools", verified: "active" },
  { name: "Levr.ai", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: true, website: "https://levr.ai", applyUrl: "https://levr.ai/pricing/", phone: ".", criteria: "ISO ✓ white-label · AI platform: brokers submit complete apps (term/MCA/SBA) -> routed to lender network; automates intake/docs", verified: "active" },
  { name: "Ivy Lender", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: true, website: "https://www.ivylender.com", applyUrl: "https://www.ivylender.com/e-broker-platform", criteria: "ISO ✓ white-label · White-label broker platform; AI matches each app to 100+ lenders (US + Canada); embeds white-label app on broker site", verified: "active" },
  { name: "Working Capital Marketplace", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://www.workingcapitalmarketplace.com", criteria: "ISO ✗ merchant-facing · Tech marketplace -> wide lender spectrum via one process; dedicated consultants + wholesale pricing", verified: "active" },
  { name: "Finance Lobby", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://financelobby.com", criteria: "ISO ✗ merchant-facing · CRE ONLY: post a deal once -> 10,500+ verified lenders compete/quote; $40B transacted (useful if MFunding expands to CRE)", verified: "active" },
  { name: "Lendflow", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: false, website: "https://www.lendflow.com", applyUrl: "https://www.lendflow.com/lendflow-connect", criteria: "ISO ✗ merchant-facing · Embedded credit infra: neutral network of 75+ lenders via unified API + widgets; powers Experian's SMB marketplace", verified: "active" },
  { name: "Fundwell", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.fundwell.com", applyUrl: "https://www.fundwell.com/partners/loan-brokers", phone: "800-613-0257", criteria: "ISO ~ referral only · SMB lending marketplace (term/LOC/RBF/SBA/non-dilutive); $1B+ funded; A+ BBB; partner/referral program", verified: "active" },
  { name: "Hello Alice", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://helloalice.com", applyUrl: "https://helloalice.com/funding/loans/", criteria: "ISO ✗ merchant-facing · SMB loan marketplace -> 90+ lenders (SBA/microloans/term/RE/MCA); powered by Lendflow; no credit impact", verified: "active" },
  { name: "FinMkt", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: false, website: "https://www.finmkt.io", applyUrl: "https://www.finmkt.io/product/multi-lender-platform", criteria: "ISO ✗ merchant-facing · Multi-lender POS financing: single universal app, customizable lender waterfalls, soft-pull prequal (POS/consumer-oriented)", verified: "active" },
  { name: "ChargeAfter", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: false, website: "https://chargeafter.com", applyUrl: "https://chargeafter.com/lenders/", phone: "888-272-7228", criteria: "ISO ✗ merchant-facing · Embedded financing: real-time matching routes one app across a large lender network (consumer/B2B POS waterfall)", verified: "active" },
  { name: "Clarify Capital", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://clarifycapital.com", applyUrl: "https://clarifycapital.com/partners", phone: "800-664-0173", criteria: "ISO ~ referral only · One app -> 75+ lenders (term/LOC/SBA/equipment/factoring/MCA up to $5M in ~24h); 500+ FICO, $10K+/mo; 800+ Trustpilot", verified: "active" },
  { name: "Become", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://www.become.co", applyUrl: "https://www.become.co/apply/", criteria: "ISO ✗ merchant-facing · Algorithmic matching to lender network (RBF + business loans); LendingScore dashboard improves odds; US & AU", verified: "active" },
  { name: "Lantern by SoFi", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://www.lanterncredit.com/small-business", applyUrl: "https://www.lanterncredit.com/small-business", criteria: "ISO ✗ merchant-facing · SoFi-owned comparison marketplace -> multiple partners (term/SBA/LOC/equipment/factoring/RBF/MCA); no-credit-impact compare", verified: "active" },
  { name: "Lendzi", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.lendzi.com", applyUrl: "https://www.lendzi.com/partners", phone: "877-897-3773", criteria: "ISO ~ referral only · One app -> 60+ lenders (term/LOC/SBA/MCA/equipment); funds in 24h; not a direct lender", verified: "active" },
  { name: "Loan Pros", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://loan-pros.net", applyUrl: "https://loan-pros.net", phone: "704-991-7885", criteria: "ISO ✗ merchant-facing · One app -> 75+ funders (term/LOC/SBA/equipment/MCA); $25K+/mo; operated by ROK Financial", verified: "active" },
  { name: "Swoop Funding", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://swoopfunding.com/us", applyUrl: "https://swoopfunding.com/us/about-swoop/partners", phone: "202-804-9308", criteria: "ISO ✓ submit · One app -> matched across loans/equity/grants (SBA/term/LOC/equipment/CRE); $500-$10M; US arm of UK platform", verified: "active" },
  { name: "Approvd", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://www.yourapprovd.com", applyUrl: "https://www.yourapprovd.com/get-started", phone: "516-262-5269", criteria: "ISO ✗ merchant-facing · 'One application, 75+ lenders competing'; $10K-$5M; 500+ FICO; RBF/LOC/term/SBA/equipment; explicitly a marketplace", verified: "active" },
  { name: "Bay Street Lending", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://www.baystreetlending.com", applyUrl: "https://www.baystreetlending.com/#apply", phone: "929-933-6121", criteria: "ISO ✗ merchant-facing · One app -> 50+ lenders, 2-3 real offers; 6+ mo, $10K+/mo, 500+ FICO; WC/SBA/equipment/LOC/factoring/MCA; 24h; lender-paid", verified: "active" },
  { name: "LoanBud", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://loanbud.com", applyUrl: "https://loanbud.com/loans/referral-partners", criteria: "ISO ~ referral only · One app -> ~50 lenders; SBA-focused (Fasttrack/Boost); 650+ FICO, $75K+ revenue", verified: "active" },
  { name: "SMB Compass", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.smbcompass.com", applyUrl: "https://www.smbcompass.com/partner-program", phone: "646-569-9496", criteria: "ISO ~ referral only · Apply -> compare options from partners; 9 products (SBA/ABL/invoice/equipment/gov-contract); $250M+; all 50 states", verified: "active" },
  { name: "The Broker Shop", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://thebrokershopinc.com", applyUrl: "https://thebrokershopinc.com", criteria: "ISO ✗ merchant-facing · One ~2-min app -> 50+ vetted lenders; pick top 2-3 offers; MCA/term/LOC/equipment/SBA/factoring/RBF; lender-paid", verified: "active" },
  { name: "ClearValue Lending", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://clearvaluelending.com", applyUrl: "https://clearvaluelending.com/small-business-financing", criteria: "ISO ✗ merchant-facing · Soft-pull app -> matched to lender partner most likely to fund; $5K-$500K; 500+ FICO, 6mo, $10K/mo", verified: "active" },
  { name: "Pro Funding Options", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.profundingoptions.com", applyUrl: "https://www.profundingoptions.com/merchant-iso-referral-program/", criteria: "ISO ✓ submit · Self-described funding marketplace; 2-min soft-pull -> compare offers w/ specialist; SBA/LOC/term/WC/equipment", verified: "active" },
  { name: "RAN Funding", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://ranfunding.com", applyUrl: "https://ranfunding.com", criteria: "ISO ✗ merchant-facing · Prequal in minutes, funded 24-48h; matched across term/MCA/SBA/LOC from lender network; 9.8 Trustpilot", verified: "active" },
  { name: "BitX Capital", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://bitxcapital.com", applyUrl: "https://bitxcapital.com", phone: "203-836-9280", criteria: "ISO ✗ merchant-facing · Connects to a network of lenders (SBA/MCA/LOC/term); up to $5M; est. 2014", verified: "active" },
  { name: "Elite Funders", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://elitefunders.com", applyUrl: "https://elitefunders.com/company/partnerships", phone: "888-896-5559", criteria: "ISO ✓ submit · AI-assisted marketplace: apply to 70+ lenders simultaneously incl. MCA; $10K-$5M; no hard pull; competing offers", verified: "active" },
  { name: "Your FundingTree", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://www.yourfundingtree.com", applyUrl: "https://www.yourfundingtree.com", criteria: "ISO ✗ merchant-facing · One app -> proposals from multiple lenders (MCA/RBF); $15K-$50MM+; free, no credit impact", verified: "active" },
  { name: "FSE (Funding Solution Experts)", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://www.fseb2b.com", applyUrl: "https://www.fseb2b.com", criteria: "ISO ✗ merchant-facing · Shops 50+ lending partners on one app incl. MCA; $20K-$2M+ in 24-48h; zero upfront fees", verified: "active" },
  { name: "AMP Advance", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: false, website: "https://ampadvance.com", applyUrl: "https://ampadvance.com", criteria: "ISO ✗ merchant-facing · One app -> multiple offers incl. MCA/RBF; no hard credit check; RBF-focused among products", verified: "active" },
  { name: "Summit Private Credit", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://summitprivatecredit.com", applyUrl: "https://summitprivatecredit.com/iso", criteria: "ISO ✓ submit · Direct funder + broker pooling 70+ lenders; 'one app, 70+ funders compete, pick lowest'; $5K-$25M; 3+ mo, $10K+/mo, 500+", verified: "active" },
];
