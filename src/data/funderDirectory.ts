...
const ENRICHED: Funder[] = [
  ...
  { name: "1 West", category: "marketplace", lowRev: true, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.1west.com", applyUrl: "https://www.1west.com/partner", phone: "888-881-9378", criteria: "ISO ✓ submit · Network of 50+ lenders (ABLE engine) · partner portal + account exec · 5–7 day vetting · 💲 Free (lender-paid, application-based)" },
  { name: "Torro", category: "marketplace", paper: "B-D", lowRev: true, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://torro.com", applyUrl: "https://torro.com/partnership/iso", phone: "1-866-858-2404", criteria: "ISO ✓ submit · Submits to marketplace of 25+ funders · funds startups · partner CRM provided · 💲 Pricing not published (contact form)" },
  ...
  { name: "Money-360", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.money-360.com", applyUrl: "https://www.money-360.com/for-isos", criteria: "ISO ✓ submit · ISO submits once -> smart-matched to 50+ direct lenders; real-time tracking + weekly payouts; not a direct lender · 💲 Free (lender-paid) — but US access currently restricted/waitlist", verified: "active" },
  { name: "RelFi", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://relfi.co", applyUrl: "https://relfi.co/partner", criteria: "ISO ✓ submit · ISO funding marketplace -> 75+ funders (working capital/SBA/asset-backed); ~$220M/mo volume; single submission · 💲 Free (lender-paid, commissions bi-weekly)", verified: "active" },
  { name: "Lenders Access", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://lendersaccess.com", applyUrl: "https://lendersaccess.com/#register", criteria: "ISO ✓ submit · Broker submits one app -> 10-15 options from 98+ programs, often within an hour; free; 1,700+ brokers; $325M deployed (submit@lendersaccess.com) · 💲 Free — $0, no setup/subscription fees", verified: "active" },
  { name: "Funding Network", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: true, website: "https://www.fundingnetwork.dev", applyUrl: "https://fundingnetwork.dev/#brokers", criteria: "ISO ✓ submit · Broker submits merchant file once; command center tracks offers across matched lender network; white-label doc portal · 💲 Pricing not published (contact for pricing; SaaS platform)", verified: "active" },
  { name: "B2 Systems", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://b2systems.io", applyUrl: "https://b2systems.io/funder-submissions", criteria: "ISO ✓ submit · Broker sends one MCA file -> matched funders from 70+ network; replies to inbox; app-reader/statement-parser tools · 💲 PAID — $199/mo + $6.99/deal (broker SaaS; 7-day free trial)", verified: "active" },
  { name: "Levr.ai", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: true, website: "https://levr.ai", applyUrl: "https://levr.ai/pricing/", phone: ".", criteria: "ISO ✓ white-label · AI platform: brokers submit complete apps (term/MCA/SBA) -> routed to lender network; automates intake/docs · 💲 Free — $0/mo Broker Plan, keep 100% commission", verified: "active" },
  { name: "Ivy Lender", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: true, website: "https://www.ivylender.com", applyUrl: "https://www.ivylender.com/e-broker-platform", criteria: "ISO ✓ white-label · White-label broker platform; AI matches each app to 100+ lenders (US + Canada); embeds white-label app on broker site · 💲 Pricing not published (white-label 'affordable tech'; demo by request)", verified: "active" },
  { name: "Swoop Funding", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://swoopfunding.com/us", applyUrl: "https://swoopfunding.com/us/about-swoop/partners", phone: "202-804-9308", criteria: "ISO ✓ submit · One app -> matched across loans/equity/grants (SBA/term/LOC/equipment/CRE); $500-$10M; US arm of UK platform · 💲 Free (lender-paid)", verified: "active" },
  { name: "Pro Funding Options", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.profundingoptions.com", applyUrl: "https://www.profundingoptions.com/merchant-iso-referral-program/", criteria: "ISO ✓ submit · Self-described funding marketplace; 2-min soft-pull -> compare offers w/ specialist; SBA/LOC/term/WC/equipment · 💲 Free (lender-paid, on funded deals)", verified: "active" },
  { name: "Elite Funders", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://elitefunders.com", applyUrl: "https://elitefunders.com/company/partnerships", phone: "888-896-5559", criteria: "ISO ✓ submit · AI-assisted marketplace: apply to 70+ lenders simultaneously incl. MCA; $10K-$5M; no hard pull; competing offers · 💲 Free (lender-paid, no setup fees)", verified: "active" },
  { name: "Summit Private Credit", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://summitprivatecredit.com", applyUrl: "https://summitprivatecredit.com/iso", criteria: "ISO ✓ submit · Direct funder + broker pooling 70+ lenders; 'one app, 70+ funders compete, pick lowest'; $5K-$25M; 3+ mo, $10K+/mo, 500+ · 💲 Pricing not published (gated ISO portal)", verified: "active" },
];
