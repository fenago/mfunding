...
const ENRICHED: Funder[] = [
  ...
  { name: "Money-360", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.money-360.com", applyUrl: "https://www.money-360.com/for-isos", criteria: "ISO submits once -> smart-matched to 50+ direct lenders; real-time tracking + weekly payouts; not a direct lender", verified: "active" },
  { name: "RelFi", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://relfi.co", applyUrl: "https://relfi.co/partner", criteria: "ISO funding marketplace -> 75+ funders (working capital/SBA/asset-backed); ~$220M/mo volume; single submission", verified: "active" },
  { name: "Lenders Access", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://lendersaccess.com", applyUrl: "https://lendersaccess.com", criteria: "Broker submits one app -> 10-15 options from 98+ programs, often within an hour; free; 1,700+ brokers; $325M deployed (submit@lendersaccess.com)", verified: "active" },
  { name: "Funding Network", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: true, website: "https://www.fundingnetwork.dev", applyUrl: "https://www.fundingnetwork.dev", criteria: "Broker submits merchant file once; command center tracks offers across matched lender network; white-label doc portal", verified: "active" },
  { name: "B2 Systems", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://b2systems.io", applyUrl: "https://b2systems.io/funder-submissions", criteria: "Broker sends one MCA file -> matched funders from 70+ network; replies to inbox; app-reader/statement-parser tools", verified: "active" },
  { name: "Levr.ai", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: true, website: "https://levr.ai", applyUrl: "https://levr.ai", phone: ".", criteria: "AI platform: brokers submit complete apps (term/MCA/SBA) -> routed to lender network; automates intake/docs", verified: "active" },
  { name: "Ivy Lender", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: true, website: "https://www.ivylender.com", applyUrl: "https://www.ivylender.com/e-broker-platform", criteria: "White-label broker platform; AI matches each app to 100+ lenders (US + Canada); embeds white-label app on broker site", verified: "active" },
  { name: "Working Capital Marketplace", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.workingcapitalmarketplace.com", criteria: "Tech marketplace -> wide lender spectrum via one process; dedicated consultants + wholesale pricing", verified: "active" },
  { name: "Finance Lobby", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://financelobby.com", criteria: "CRE ONLY: post a deal once -> 10,500+ verified lenders compete/quote; $40B transacted (useful if MFunding expands to CRE)", verified: "active" },
  { name: "Lendflow", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: true, website: "https://www.lendflow.com", applyUrl: "https://www.lendflow.com/lendflow-connect", criteria: "Embedded credit infra: neutral network of 75+ lenders via unified API + widgets; powers Experian's SMB marketplace", verified: "active" },
  { name: "Fundwell", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.fundwell.com", applyUrl: "https://www.fundwell.com/partners", phone: "800-613-0257", criteria: "SMB lending marketplace (term/LOC/RBF/SBA/non-dilutive); $1B+ funded; A+ BBB; partner/referral program", verified: "active" },
  { name: "Hello Alice", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://helloalice.com", applyUrl: "https://helloalice.com/funding/loans/", criteria: "SMB loan marketplace -> 90+ lenders (SBA/microloans/term/RE/MCA); powered by Lendflow; no credit impact", verified: "active" },
  { name: "FinMkt", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: true, website: "https://www.finmkt.io", applyUrl: "https://www.finmkt.io/product/multi-lender-platform", criteria: "Multi-lender POS financing: single universal app, customizable lender waterfalls, soft-pull prequal (POS/consumer-oriented)", verified: "active" },
  { name: "ChargeAfter", category: "marketplace", lowRev: false, whiteLabel: true, applyOnce: true, isoProgram: true, website: "https://chargeafter.com", applyUrl: "https://chargeafter.com/lenders/", phone: "888-272-7228", criteria: "Embedded financing: real-time matching routes one app across a large lender network (consumer/B2B POS waterfall)", verified: "active" },
  { name: "Clarify Capital", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://clarifycapital.com", applyUrl: "https://clarifycapital.com/apply", phone: "800-664-0173", criteria: "One app -> 75+ lenders (term/LOC/SBA/equipment/factoring/MCA up to $5M in ~24h); 500+ FICO, $10K+/mo; 800+ Trustpilot", verified: "active" },
  { name: "Become", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.become.co", applyUrl: "https://www.become.co/apply/", criteria: "Algorithmic matching to lender network (RBF + business loans); LendingScore dashboard improves odds; US & AU", verified: "active" },
  { name: "Lantern by SoFi", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.lanterncredit.com/small-business", applyUrl: "https://www.lanterncredit.com/small-business", criteria: "SoFi-owned comparison marketplace -> multiple partners (term/SBA/LOC/equipment/factoring/RBF/MCA); no-credit-impact compare", verified: "active" },
  { name: "Lendzi", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.lendzi.com", applyUrl: "https://www.lendzi.com/apply-loan/", phone: "877-897-3773", criteria: "One app -> 60+ lenders (term/LOC/SBA/MCA/equipment); funds in 24h; not a direct lender", verified: "active" },
  { name: "Loan Pros", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://loan-pros.net", applyUrl: "https://loan-pros.net", phone: "704-991-7885", criteria: "One app -> 75+ funders (term/LOC/SBA/equipment/MCA); $25K+/mo; operated by ROK Financial", verified: "active" },
  { name: "Swoop Funding", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://swoopfunding.com/us", applyUrl: "https://swoopfunding.com/us", phone: "202-804-9308", criteria: "One app -> matched across loans/equity/grants (SBA/term/LOC/equipment/CRE); $500-$10M; US arm of UK platform", verified: "active" },
  { name: "Approvd", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.yourapprovd.com", applyUrl: "https://www.yourapprovd.com/get-started", phone: "516-262-5269", criteria: "'One application, 75+ lenders competing'; $10K-$5M; 500+ FICO; RBF/LOC/term/SBA/equipment; explicitly a marketplace", verified: "active" },
  { name: "Bay Street Lending", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.baystreetlending.com", applyUrl: "https://www.baystreetlending.com/#apply", phone: "929-933-6121", criteria: "One app -> 50+ lenders, 2-3 real offers; 6+ mo, $10K+/mo, 500+ FICO; WC/SBA/equipment/LOC/factoring/MCA; 24h; lender-paid", verified: "active" },
  { name: "LoanBud", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://loanbud.com", applyUrl: "https://apply.loanbud.com/", criteria: "One app -> ~50 lenders; SBA-focused (Fasttrack/Boost); 650+ FICO, $75K+ revenue", verified: "active" },
  { name: "SMB Compass", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.smbcompass.com", applyUrl: "https://www.smbcompass.com/apply-now", phone: "646-569-9496", criteria: "Apply -> compare options from partners; 9 products (SBA/ABL/invoice/equipment/gov-contract); $250M+; all 50 states", verified: "active" },
  { name: "The Broker Shop", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://thebrokershopinc.com", applyUrl: "https://thebrokershopinc.com", criteria: "One ~2-min app -> 50+ vetted lenders; pick top 2-3 offers; MCA/term/LOC/equipment/SBA/factoring/RBF; lender-paid", verified: "active" },
  { name: "ClearValue Lending", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://clearvaluelending.com", applyUrl: "https://clearvaluelending.com/small-business-financing", criteria: "Soft-pull app -> matched to lender partner most likely to fund; $5K-$500K; 500+ FICO, 6mo, $10K/mo", verified: "active" },
  { name: "Pro Funding Options", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.profundingoptions.com", applyUrl: "https://www.profundingoptions.com", criteria: "Self-described funding marketplace; 2-min soft-pull -> compare offers w/ specialist; SBA/LOC/term/WC/equipment", verified: "active" },
  { name: "RAN Funding", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://ranfunding.com", applyUrl: "https://ranfunding.com", criteria: "Prequal in minutes, funded 24-48h; matched across term/MCA/SBA/LOC from lender network; 9.8 Trustpilot", verified: "active" },
  { name: "BitX Capital", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://bitxcapital.com", applyUrl: "https://bitxcapital.com", phone: "203-836-9280", criteria: "Connects to a network of lenders (SBA/MCA/LOC/term); up to $5M; est. 2014", verified: "active" },
  { name: "Elite Funders", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://elitefunders.com", applyUrl: "https://elitefunders.com", phone: "888-896-5559", criteria: "AI-assisted marketplace: apply to 70+ lenders simultaneously incl. MCA; $10K-$5M; no hard pull; competing offers", verified: "active" },
  { name: "Your FundingTree", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.yourfundingtree.com", applyUrl: "https://www.yourfundingtree.com", criteria: "One app -> proposals from multiple lenders (MCA/RBF); $15K-$50MM+; free, no credit impact", verified: "active" },
  { name: "FSE (Funding Solution Experts)", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://www.fseb2b.com", applyUrl: "https://www.fseb2b.com", criteria: "Shops 50+ lending partners on one app incl. MCA; $20K-$2M+ in 24-48h; zero upfront fees", verified: "active" },
  { name: "AMP Advance", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://ampadvance.com", applyUrl: "https://ampadvance.com", criteria: "One app -> multiple offers incl. MCA/RBF; no hard credit check; RBF-focused among products", verified: "active" },
  { name: "Summit Private Credit", category: "marketplace", lowRev: false, whiteLabel: false, applyOnce: true, isoProgram: true, website: "https://summitprivatecredit.com", applyUrl: "https://summitprivatecredit.com/business-funding", criteria: "Direct funder + broker pooling 70+ lenders; 'one app, 70+ funders compete, pick lowest'; $5K-$25M; 3+ mo, $10K+/mo, 500+", verified: "active" },
];
