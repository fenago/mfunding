...
def mgmt_sql(ref, token, query):
    ...
    req = urllib.request.Request(
        ...
        # A real User-Agent is REQUIRED: the management-API WAF 403s the default
        # "Python-urllib/x.y" UA (verified 2026-08-03). Without this the loader
        # fails headless (e.g. from the ph-ucc-fl-fetch GitHub Action).
